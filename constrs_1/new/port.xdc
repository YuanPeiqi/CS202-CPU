...
set_property PACKAGE_PIN Y8 [get_ports {switch[19]}]
set_property PACKAGE_PIN AA8 [get_ports {switch[21]}]
set_property PACKAGE_PIN V8 [get_ports {switch[22]}]
set_property PACKAGE_PIN V9 [get_ports {switch[23]}]
set_property PACKAGE_PIN AB8 [get_ports {switch[20]}]
